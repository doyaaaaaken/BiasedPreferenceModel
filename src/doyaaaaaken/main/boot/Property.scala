...
object Property {
  ...
  lazy val csvOutputTop40Trait: Boolean = map.apply("sim.csv.output.top40trait").toBoolean
  lazy val csvOutputFileNameForTop40Trait: String = map.apply("sim.csv.fileName.top40trait").toString
